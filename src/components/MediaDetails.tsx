...
const MediaDetails: React.FC<MediaDetailsProps> = ({
  ...
  const displayYear =
    media.type === "music" ? media.year : releaseYear || media.year;
  const displayBackdrop =
    media.type === "music" ? media.poster : backdrop || displayPoster;
        ...
        <div className="space-y-6">
          <div>
            ...
            <p className="text-gray-300 leading-relaxed text-base">
              {displayDescription ||
                `Découvrez ${displayTitle}, un ${
                  media.type === "movie"
                    ? "film"
                    : media.type === "series"
                    ? "série"
                    : "contenu musical"
                } captivant disponible sur votre plateforme de streaming personnelle.`}
            </p>
          </div>
                ...
                {displayDescription ||
                  `Découvrez ${displayTitle}, un ${
                    media.type === "movie"
                      ...
                      ? "série"
                      : "contenu musical"
                  } captivant disponible sur votre plateforme de streaming personnelle. Une expérience de divertissement unique vous attend.`}
              </p>
            </div>
                      ...
                      <div className="flex-1">
                        ...
                        {episode.seasonNumber && episode.episodeNumber && (
                          <div className="text-gray-400">
                            Saison {episode.seasonNumber} • Épisode{" "}
